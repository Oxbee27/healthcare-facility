...
export default function PatientDashboard({
  ...
  function scrollToCareTeam() {
    document
      .getElementById("care-team-gallery")
  ...
  return (
    <main>
      ...
      <Hero
        ...
        onExploreCareTeam={scrollToCareTeam}
      />
      ...
      <section
        className="
          flex flex-col items-stretch justify-between gap-5
          rounded-2xl bg-[#12232B] px-5 py-5 sm:flex-row sm:items-center sm:gap-6 sm:px-7 sm:py-[26px]
      ...
      >
        <div className="flex items-start gap-3.5 sm:items-center">
          <Avatar
            src={PATIENT.nextAppointment.providerPhoto}
            initials={PATIENT.nextAppointment.providerInitials}
            size="large"
            className="hidden shrink-0 border-2 border-white/15 sm:flex"
          />
          ...
          <div>
            ...
            <h2 className="m-0 mb-1.5 font-['Newsreader'] text-[20px] font-semibold leading-snug sm:text-[22px]">
        ...
        <div className="flex w-full flex-col gap-2.5 sm:w-auto sm:flex-row">
          ...
          >
            <span className="truncate">Join video visit</span>
          </Button>
          ...
          <Button
            ...
            className="
              w-full border-[rgba(237,239,233,0.3)] sm:w-auto
              bg-transparent
              text-[#EDEFE9]
      ...
      {/* Care team in action — rotating photo gallery */}
      <div className="mt-5 sm:mt-[22px]">
        <CareGallery />
      </div>

      {/* Main dashboard */}
      <div className="mt-5 grid min-w-0 gap-4 sm:mt-[22px] sm:gap-5 lg:grid-cols-[1.5fr_1fr]">
        {/* LEFT */}
        ...
        <div className="flex flex-col gap-5">
          ...
          <Panel className="animate-rise">
            ...
            <div>
              {PATIENT.careTeam.map((person, personIndex) => (
                <div
                  key={person.name}
                  className="
                    group flex flex-col items-stretch gap-3
                    border-b sm:flex-row sm:items-center sm:gap-4 border-[rgba(18,35,43,0.07)]
                    px-4 py-4 sm:px-6
                    last:border-b-0
                    animate-rise
                  "
                  style={{ animationDelay: `${personIndex * 90}ms` }}
                >
                  <Avatar
                    src={person.photo}
  ...
  return (
    <div className="w-full min-w-0 overflow-x-auto overflow-y-hidden">
      <svg
        ...
        className="h-[150px] min-w-[420px] w-full sm:h-[160px]"
      >
        <defs>
          <linearGradient
            id="healthGradient"
